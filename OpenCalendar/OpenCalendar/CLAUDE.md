...
- First focused on daily/weekly views optimized for mobile

## Key Features to Build
1. Week view with 96 15-minutes time slots (00:00 - 00:00)
2. Day view for focused single-day planning
3. Event creation by tapping time slots
4. Event editing and deletion
5. Clean event cards with title, time, optional notes
6. Smooth scrolling and gesture interactions

## Development Approach
- Start with single day layout
